...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex overflow-hidden">
      ...
      {/* ── Right panel — form ── */}
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-10 py-8 lg:py-12 relative min-h-0">

        {/* Ambient glow mobile */}
        <div className="lg:hidden absolute -top-20 right-0 w-72 h-72 rounded-full pointer-events-none"
             style={{ background: 'radial-gradient(circle, oklch(0.76 0.175 192 / 0.1) 0%, transparent 70%)' }} />

        <div className="w-full max-w-sm flex flex-col gap-6 lg:gap-0 relative">

          {/* Mobile hero */}
          <div className="lg:hidden">
            <span className="font-[family-name:var(--font-syne)] text-[10px] font-600 tracking-[0.22em] uppercase text-muted-foreground block mb-5">
              Surf.Community
            </span>
            <p className="font-[family-name:var(--font-syne)] text-[10px] font-600 tracking-[0.18em] uppercase text-primary mb-3">
              Your Ocean Network
            </p>
            <h1 className="font-[family-name:var(--font-syne)] font-800 text-[2.6rem] leading-[0.92] tracking-[-0.02em] text-foreground">
              Find your<br />
              <span className="text-primary">crew.</span> Catch<br />the swell.
            </h1>
            ...
            <div className="flex items-center gap-4 mt-5">
              <div className="h-px flex-1 bg-border/50" />
              <span className="text-[9px] text-muted-foreground font-500 tracking-[0.12em] uppercase">Sign in</span>
              <div className="h-px flex-1 bg-border/50" />
            </div>
          </div>
          ...
          {/* Form */}
          <div>
            <h2 className="hidden lg:block font-[family-name:var(--font-syne)] font-700 text-2xl tracking-tight text-foreground mb-1">
              Sign in
            </h2>
            <p className="hidden lg:block text-muted-foreground text-sm mb-8 font-300">
